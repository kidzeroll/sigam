...
<body>
    ...
    <div style="margin: 1cm">
        ...
        <div style="margin-top: 20px" class="text-center">
            <b style="text-decoration: underline;">SURAT KETERANGAN DOMISILI</b>
            <br>
            Nomor : {{ $no }}/{{ $gampong->kode_gampong }}-SKD/{{ $bln }}/{{ date('Y') }}
        </div>
        ...
        <div style="text-align: justify;">
            <p>
                ...
                {{ $gampong->nama_kabupaten }} dan sepengetahuan kami yang bersangkutan <b>Sudah tinggal dan menetap
                    (berdomisili) di Gampong {{ $gampong->nama_gampong }}</b>.
            </p>
            <p>
