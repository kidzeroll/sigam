...
<body>
    ...
    <div style="margin: 1cm">
        ...
        <div style="margin-top: 20px" class="text-center">
            <b style="text-decoration: underline;">SURAT KETERANGAN PINDAH</b>
            <br>
            Nomor : {{ $no }}/{{ $gampong->kode_gampong }}-SKP/{{ $bln }}/{{ date('Y') }}
        </div>
        ...
        <div style="text-align: justify;">
            <p>
                ...
                {{ $gampong->nama_kabupaten }}, benar yang bersangkutan telah memohon untuk pindah tempat tinggal ke
                <b>{{ $data->tujuan_pindah }}</b> mulai tanggal
                <b>{{ $data->tanggal_pindah->isoFormat('d MMMM Y') }}</b>.
            </p>
            <p>
