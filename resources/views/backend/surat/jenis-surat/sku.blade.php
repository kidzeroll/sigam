...
<body>
    ...
    <div style="margin: 1cm">
        ...
        <div style="margin-top: 20px" class="text-center">
            <b style="text-decoration: underline;">SURAT KETERANGAN USAHA</b>
            <br>
            Nomor : {{ $no }}/{{ $gampong->kode_gampong }}-SKU/{{ $bln }}/{{ date('Y') }}
        </div>
        ...
        <div style="text-align: justify;">
            <p>
                ...
                {{ $gampong->nama_kabupaten }} dan sepengetahuan kami yang bersangkutan memiliki
                <b>Usaha {{ $data->bidang_usaha }}</b> yang bertempat di <b>{{ $data->alamat_usaha }}</b>.
            </p>
            <p>
