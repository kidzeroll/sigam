    ...
    <div style="margin: 1cm">
        ...
        <div style="text-align: justify;">
            <p>
                ...
                {{ $gampong->nama_kabupaten }} dan benar pula yang bersangkutan telah meninggal dunia pada :
            </p>
        </div>
        ...
        <table style="margin-left: 45px; ">
            <tr>
                <td>Hari/Tanggal</td>
                <td>:</td>
                <td>{{ $data->tanggal_meninggal->isoFormat('dddd, D MMMM Y') }}</td>
            </tr>
            <tr>
                <td>Pukul</td>
                <td>:</td>
                <td>{{ $data->pukul_meninggal }} WIB</td>
            </tr>
            <tr>
                <td>Disebabkan</td>
                <td>:</td>
        ...
        <table style="margin-left: 45px; ">
            <tr>
                <td>Hari/Tanggal</td>
                <td>:</td>
                <td>{{ $data->tanggal_dikebumikan->isoFormat('dddd, D MMMM Y') }}</td>
            </tr>
            <tr>
                <td>Pukul</td>
                <td>:</td>
                <td>{{ $data->pukul_dikebumikan }} WIB</td>
            </tr>
            <tr>
                <td>Tempat</td>
                <td>:</td>
        ...
        <!--ttd-->
        <div>
            <div style="margin-left: 50%; width: 50%; margin-top: 10px" class="text-center">
