...
<body>
    ...
    <div style="margin: 1cm">
        ...
        <div style="margin-top: 20px" class="text-center">
            <b style="text-decoration: underline;">SURAT KETERANGAN BERKELAKUAN BAIK</b>
            <br>
            Nomor : {{ $no }}/{{ $gampong->kode_gampong }}-SKBB/{{ $bln }}/{{ date('Y') }}
        </div>
        ...
        <div style="text-align: justify;">
            <p>
                ...
                {{ $gampong->nama_kabupaten }} dan sepengetahuan kami yang bersangkutan <b>Berkelakuan baik, juga tidak
                    pernah terlibat dalam suatu organisasi terlarang atau tindak kriminal</b>.
            </p>
            <p>
                Surat Keterangan ini kami keluarkan untuk keperluan <b>{{ $data->keperluan }}</b>.
            </p>
            <p>
