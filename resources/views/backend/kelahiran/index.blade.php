<x-backend-layout>
    <x-slot name="title">Data Kelahiran</x-slot>

    <x-card class="card-primary" label="Tabel Data Kelahiran">
        <x-slot name="button">
            <button type="button" class="btn btn-primary show-modal" url="{{ route('kelahiran.create') }}"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('body').on('click', '.show-modal', function() {
                    ...
                    $('#modal-title').text(title + ' Data Kelahiran');
                    $('#modal-btn-save')
