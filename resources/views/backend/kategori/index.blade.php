<x-backend-layout>
    ...
    <x-card class="card-primary" label="Tabel Kategori">
        <x-slot name="button">
            <button type="button" class="btn btn-primary show-modal" url="{{ route('kategori.create') }}"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('body').on('click', '.show-modal', function() {
                    ...
                    $('#modal-title').text(title + ' Kategori');
                    $('#modal-btn-save')
