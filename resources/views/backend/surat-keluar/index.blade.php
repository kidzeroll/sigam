<x-backend-layout>
    <x-slot name="title">Kelola Surat Keluar</x-slot>

    <x-card class="card-primary" label="Tabel Surat Keluar">
        <x-slot name="button">
            <button type="button" class="btn btn-primary show-modal" url="{{ route('surat-keluar.create') }}"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('body').on('click', '.show-modal', function() {
                    ...
                    $('#modal-title').text(title + ' Surat Keluar');
                    $('#modal-btn-save')
                ...
                $('body').on('click', '.btn-delete', function(event) {
                    ...
                    swal({
                            title: 'Apakah anda ingin menghapus surat keluar?',
                            text: '',
                            icon: 'warning',
                            buttons: true,
                            dangerMode: true,
