<x-backend-layout>
    ...
    <x-card class="card-primary" label="Tabel Artikel">
        <x-slot name="button">
            <button type="button" class="btn btn-primary show-modal" url="{{ route('artikel.create') }}"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('body').on('click', '.show-modal', function() {
                    ...
                    $('#modal-title').text(title + ' Artikel');
                    $('#modal-btn-save')
                ...
                $('body').on('click', '.btn-delete', function(event) {
                    ...
                    swal({
                            title: 'Apakah anda ingin menghapus artikel?',
                            text: '',
                            icon: 'warning',
                            buttons: true,
                            dangerMode: true,
