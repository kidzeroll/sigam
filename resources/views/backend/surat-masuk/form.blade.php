{!! Form::model($model, [
    'route' => $model->exists ? ['surat-masuk.update', $model->id] : 'surat-masuk.store',
...
<div class="row">
    ...
    <div class="form-group col-md-6 col-12">
        ...
        <input type="date" class="form-control  @error('tanggal_masuk') is-invalid @enderror" id="tanggal_masuk"
            name="tanggal_masuk" value="{{ old('tanggal_masuk', $model->tanggal_masuk?->format('Y-m-d') ?? '') }}">
    </div>
...
<div class="row">
    ...
    <div class="form-group col-md-12 col-12">
        ...
        <input type="text" class="form-control  @error('pengirim') is-invalid @enderror" id="pengirim"
            name="pengirim" value="{{ old('pengirim', $model->pengirim) }}">
    </div>
