<x-backend-layout>
    <x-slot name="title">Kelola Surat Masuk</x-slot>

    <x-card class="card-primary" label="Tabel Surat Masuk">
        <x-slot name="button">
            <button type="button" class="btn btn-primary show-modal" url="{{ route('surat-masuk.create') }}"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('body').on('click', '.show-modal', function() {
                    ...
                    $('#modal-title').text(title + ' Surat Masuk');
                    $('#modal-btn-save')
                ...
                $('body').on('click', '.btn-delete', function(event) {
                    ...
                    swal({
                            title: 'Apakah anda ingin menghapus surat masuk?',
                            text: '',
                            icon: 'warning',
                            buttons: true,
                            dangerMode: true,
