<x-backend-layout>
    ...
    <x-card class="card-primary" label="Tabel Perpindahan">
        <x-slot name="button">
            <button type="button" class="btn btn-primary show-modal" url="{{ route('perpindahan.create') }}"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('body').on('click', '.show-modal', function() {
                    ...
                    $('#modal-title').text(title + ' Data Perpindahan');
                    $('#modal-btn-save')
