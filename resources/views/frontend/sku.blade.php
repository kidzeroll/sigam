                ...
                <div class="card-body">
                    <form action="{{ route('administrasi.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <!--jenis_surat-->
                            <input type="hidden" value="SKU" name="jenis_surat" id="jenis_surat">
                        ...
                        <div class="row">
                            ...
                            <!-- bidang_usaha -->
                            <div class="form-group col-12 mt-3">
                                <label for="bidang_usaha"><span class="text-danger"><sup>*</sup></span>Bidang
                                    Usaha</label>
                                <input id="bidang_usaha" type="text"
                                    class="form-control @error('bidang_usaha') is-invalid @enderror"
                                    name="bidang_usaha" value="{{ old('bidang_usaha') }}">
                                @error('bidang_usaha')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <!-- alamat_usaha -->
                            <div class="form-group col-12 mt-3">
                                <label><span class="text-danger"><sup>*</sup></span>Alamat Usaha</label>
                                <textarea class="form-control @error('alamat_usaha') is-invalid @enderror" name="alamat_usaha" id="alamat_usaha">{{ old('alamat_usaha') }}</textarea>
                                @error('alamat_usaha')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
