                ...
                <div class="card-body">
                    <form action="{{ route('administrasi.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <!--jenis_surat-->
                            <input type="hidden" value="SKP" name="jenis_surat" id="jenis_surat">
                        ...
                        <div class="row">
                            ...
                            <!-- tujuan_pindah -->
                            <div class="form-group col-md-6 col-12 mt-3">
                                <label for="tujuan_pindah"><span class="text-danger"><sup>*</sup></span>Tujuan
                                    Pindah</label>
                                <input id="tujuan_pindah" type="text"
                                    class="form-control @error('tujuan_pindah') is-invalid @enderror"
                                    name="tujuan_pindah" value="{{ old('tujuan_pindah') }}">
                                @error('tujuan_pindah')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <!-- tanggal_pindah -->
                            <div class="form-group col-md-6 col-12 mt-3">
                                <label for="tanggal_pindah"><span class="text-danger"><sup>*</sup></span>Tanggal
                                    Pindah</label>
                                <input type="date"
                                    class="form-control  @error('tanggal_pindah') is-invalid @enderror"
                                    id="tanggal_pindah" name="tanggal_pindah" value="{{ old('tanggal_pindah') }}">
